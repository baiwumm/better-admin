...
type MyNoticesPageProps = {
  urlNoticeId: string | null;
};
...
function NoticeListSkeleton() {
  return (
    <div aria-hidden className="flex flex-col divide-y divide-separator">
              ...
              {notices.map((notice) => {
                ...
                return (
                  <ListBox.Item
                    key={notice.id}
                    className={cn(
                      "w-full rounded-none border-l-2 border-l-transparent px-4 py-4 text-start transition-all duration-200 mt-0",
