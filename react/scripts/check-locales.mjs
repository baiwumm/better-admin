/**
 * 语言包跨端同步检查（React 端入口，与 Next 端 scripts/check-locales.mjs 同一实现）。
 *
...
const REACT_ROOT = join(process.cwd(), "src", "i18n", "locales");
const NEXT_ROOT = join(process.cwd(), "..", "next", "src", "i18n", "locales");
