...
import { ProgressProvider as BProgressProvider } from "@bprogress/vue";

import ProgressBridge from "./progress-bridge.vue";
...
<template>
  <BProgressProvider color="var(--ui-primary)" height="2px">
    <ProgressBridge />
    <slot />
  </BProgressProvider>
</template>
