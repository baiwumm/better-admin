...
/**
 * 404 页面不存在插画（来源：ant-design Result 组件插画，MIT License，
 * https://github.com/ant-design/ant-design/tree/master/components/result）。
 * 纯装饰性 SVG，语义由页面的 title/subtitle 表达；svg 为根元素，
 * 外部 class 自动继承（外层用于响应式缩放，如 w-62.5 max-w-full）。
 * 对应 React 端 illustration-not-found.tsx。
 */
</script>

<template>
  <svg height="294" width="252">
    <title>No Found</title>
    <g fill="none" fill-rule="evenodd">
      <circle cx="126.75" cy="128.1" fill="#E4EBF7" r="126" />
      <circle cx="31.55" cy="130.8" fill="#FFF" r="8.3" />
      <path
      ...
      <path
        ...
        fill="#FFF"
      />
      <circle cx="204.3" cy="30" fill="#1677ff" r="29.5" />
      <path
      ...
      <path
        ...
        fill="#F2D7AD"
      />
      <path d="M123.7 128.4H99.2v-.5h24.2l7.2-10.2.4.3z" fill="#CC9B6E" />
      <path
