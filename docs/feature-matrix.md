...
| 模块           | React | Next.js | Vue | Nuxt | NestJS API | 备注                                                                                                               |
| ------------ | ----- | ------- | --- | ---- | ---------- | ---------------------------------------------------------------------------------------------------------------- |
| 组织管理         | ✅     | ✅       | ✅   | ❌    | ✅          | 左树右表 + 拖拽排序；Vue M2 已落地并冒烟验收通过（useSortable 同级拖拽整组重编号、关键词确认删除、负责人滚动加载选择）                                     |
