...
**已修复并提交（一条一提交，累计 31 个提交、覆盖 27 个编号项）**：P0 #1 #2 #42 #43；P1 #6 #8 #11 #14 #15 #16 #19 #20 #21 #22 #23 #24 #50 #52 #53 #54；P2 #7 #13 #44 #48 #49；另有半闭环两项——#12（表述已改准，是否建同步机制待拍板）、#47（死文件已删，`/settings` 四端统一形态待拍板）。
