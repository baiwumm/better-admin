import type { DirectoryEntry, ListQueryParams } from '@/lib/api-types'

import { fetchApiList } from '@/lib/api-client'

/**
 * 人员通讯录 API 层（契约 v1.6.0 阶段 2，GET /org/directory，
 * 对齐 React 端 directory-api.ts）。
 *
...
/** 通讯录列表查询 key 前缀（列表失效用） */
export const DIRECTORY_QUERY_KEY = ['org', 'directory', 'list'] as const
