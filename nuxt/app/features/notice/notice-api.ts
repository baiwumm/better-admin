import type {
  ...
  NoticeReadStatEntry,
  NoticeStatus,
  NoticeUpdateInput, ListQueryParams
} from '@/lib/api-types'
...
/**
 * 公告 API 层（契约 v1.7.0 阶段 3，/notices*，对齐 React 端 notice-api.ts）。
 *
...
/** 公告管理列表查询 key 前缀 */
export const NOTICES_QUERY_KEY = ['notices', 'list'] as const

/** 我的公告列表查询 key 前缀 */
export const MY_NOTICES_QUERY_KEY = ['notices', 'mine'] as const
