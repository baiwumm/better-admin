  ...
  <UCard>
    <template #header>
      <div class="flex flex-col gap-1">
        <h2 class="font-bold text-highlighted">{{ t(meta.titleKey) }}</h2>
        <p class="text-xs text-muted">{{ t(meta.descriptionKey) }}</p>
      </div>
    </template>
    ...
    <div class="flex flex-col gap-4">
      <div class="flex flex-col gap-1.5">
        ...
        <p class="text-sm text-default">{{ t(meta.scenarioKey) }}</p>
      </div>
