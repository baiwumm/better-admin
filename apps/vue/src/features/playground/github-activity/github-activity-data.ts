...
export const DEMO_REPOS: RepoContribution[] = [
  { name: "better-admin", count: 486, href: REPO_URL, logo: "/logo.svg" },
  {
    name: "theme-switch-animation",
    count: 132,
    href: "https://github.com/baiwumm/theme-switch-animation",
    logo: "/playground/theme-switch-animation.svg",
  },
  {
    name: "next-daily-hot",
    count: 57,
    href: "https://github.com/baiwumm/next-daily-hot",
    logo: "/playground/next-daily-hot.png",
  },
];
