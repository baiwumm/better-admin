...
| 09-23 | **六端统一上线**：全部域名生效，线上即演示环境；线上 contract-diff 31 步一致 |

## 部署状态

**六个应用已于 2026-09-23 全部上线**，域名全部生效，线上即演示环境（只读演示模式，登录页可快捷登录）：

| 应用 | 线上地址 | 平台 |
| --- | --- | --- |
| React | [react.baiwumm.com](https://react.baiwumm.com) | Cloudflare Workers（Static Assets） |
| Vue | [vue.baiwumm.com](https://vue.baiwumm.com) | Cloudflare Workers（Static Assets） |
| Next.js | [next.baiwumm.com](https://next.baiwumm.com) | Vercel |
| Nuxt | [nuxt.baiwumm.com](https://nuxt.baiwumm.com) | Vercel |
| NestJS | [nest.baiwumm.com](https://nest.baiwumm.com) | Render |
| website（本站） | [better-admin.baiwumm.com](https://better-admin.baiwumm.com) | Cloudflare Workers（静态导出） |

部署与冒烟全记录见[路线图](/docs/progress/roadmap)的「上线收官」一节。
