/**
 * 500 服务器错误插画（来源：ant-design Result 组件插画，MIT License，
...
export function IllustrationServerError({ className }: IllustrationProps) {
  return (
    <svg className={className} height="294" width="254">
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <path
          ...
          fill="#FFF"
        />
        <circle cx="201.35" cy="30.2" fill="#FF603B" r="29.7" />
        <path
        ...
        <path
          ...
          fill="#A3B4C6"
        />
        <path d="M154.1 190.1h70.5v-84.6h-70.5z" fill="#A3B4C6" />
        <path
