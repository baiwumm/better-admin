...
// 与后端契约/DTO 对齐（openapi.yaml MenuCreateRequest，contract v1.7.0）
                ...
                >
                  <Select.Trigger>
                    ...
                    {/* Select.ClearButton 渲染为 span：有值时显示、无值自动隐藏；
                        ...
                        addChild 模式父级锁定，不渲染清空按钮 */}
                    {mode !== "addChild" && <Select.ClearButton />}
                    <Select.Indicator />
                  </Select.Trigger>
                  <Select.Popover>
                    <ListBox>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      ...
                      {/* Suffix 实时字数（上限与后端 @Length(1, 20) 对齐） */}
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      ...
                      {/* Suffix 实时字数（上限与后端 @Length(0, 100) 对齐） */}
                      <InputGroup variant="secondary">
                        <InputGroup.Input
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      ...
                      {/* Suffix 实时字数（上限与后端 @Length(1, 30) 对齐） */}
                      <InputGroup variant="secondary">
                        <InputGroup.Input
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      ...
                      {/* Suffix 实时字数（上限与后端 @Length(0, 200) 对齐） */}
                      <InputGroup variant="secondary">
                        <InputGroup.Input
