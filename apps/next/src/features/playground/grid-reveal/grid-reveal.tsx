...
/**
 * Vendor 自 rare-ui（MIT）`grid-reveal`，快照来源 https://rareui.com/r/grid-reveal.json（2026-09-15）。
...
export function GridReveal({
  ...
  return (
    <div
      ref={frameRef}
      className={cn(
        "relative w-full overflow-hidden rounded-2xl bg-default [corner-shape:squircle]",
        className,
      )}
