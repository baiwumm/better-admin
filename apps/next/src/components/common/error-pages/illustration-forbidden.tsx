/**
 * 403 无权限插画（来源：ant-design Result 组件插画，MIT License，
...
export function IllustrationForbidden({ className }: IllustrationProps) {
  return (
    <svg className={className} height="294" width="251">
