...
/**
 * 演示场 › 加载动画：beUI `loader`（单组件 17 种加载动效变体），自 Vue 端同页平移。
 *
 * React 基准用 motion 关键帧，Vue / Nuxt 两端按 §21 约定一律 CSS `@keyframes` 等效
 * （详见 Loader.vue 头注释与 progress.md 2026-09-21 两端条目）；本页两区块共享
 * size 与 speed，变体名属技术专名保留英文不译。
 */
