  ...
  return [
    {
      ...
      children: [
        ...
        },
        {
          ...
          count: 32,
          children: [
            { id: 'growth-content', label: '内容运营组', leader: '刘一', count: 10 },
            { id: 'growth-channel', label: '渠道拓展组', leader: '孙朗', count: 14 }
          ]
        },
        {
          id: 'ga',
  ...
  return [
    {
      ...
      progress: 62,
      children: [
        { id: 'kr-1', label: 'KR1 新用户 7 日留存 ≥ 45%', meta: '增长团队', progress: 58 },
        { id: 'kr-2', label: 'KR2 核心功能渗透率 ≥ 60%', meta: '产品团队', progress: 71 },
        { id: 'kr-3', label: 'KR3 崩溃率降至 0.1% 以下', meta: '研发团队', progress: 84 }
      ]
    }
  ]
}
  ...
  return [
    {
      ...
      label: '关键举措',
      children: [
        { id: 'init-1', label: '新手引导流程改版', meta: '设计 + 前端', progress: 70 },
        { id: 'init-2', label: '性能与稳定性专项', meta: '架构组', progress: 90 },
