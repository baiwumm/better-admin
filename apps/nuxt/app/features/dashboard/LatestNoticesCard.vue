...
/**
 * 最新公告卡（对齐 React / Vue 端 latest-notices-card）：已发布公告标题 +
 * 发布人（头像 / 首字 fallback）+ 发布时间。服务端仅返回标题 / 时间 / 发布人
 * 显示名，不含正文与范围等敏感信息；每条两行布局，与最近动态条目高度一致。
 */
      ...
      <template v-else>
        ...
        >
          ...
          <div class="min-w-0 flex-1">
            <p class="text-default truncate text-sm">
              {{ item.title }}
            </p>
