 ...
 *
 * Next 适配：菜单树由 RSC 注入（AppHeader 透传），导航改用 next/navigation。
 */
export function CommandMenu({ state, menuTree }: CommandMenuProps) {
  ...
  return (
    <Modal.Backdrop isOpen={state.isOpen} onOpenChange={state.setOpen}>
      <Modal.Container placement="top" size="lg">
        ...
        >
          <CommandMenuBody menuTree={menuTree} onClose={state.close} />
        </Modal.Dialog>
      </Modal.Container>
    </Modal.Backdrop>
  );
