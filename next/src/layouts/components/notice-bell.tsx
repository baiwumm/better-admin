 ...
 * - 抽屉 Header 固定「未读 / 全部」筛选 Tabs（切换只重发查询，无需 Panel），
 *   列表点击条目标记已读并跳转 link；
 * - 「全部已读」一键清零，「查看我的公告」跳转 /my-notices。
 */
        ...
        <Drawer.Backdrop>
          <Drawer.Content placement="right">
            <Drawer.Dialog className="w-100 max-w-full">
              ...
              <Drawer.Body className="min-h-0 flex-1 overflow-y-auto py-2">
              ...
              <Drawer.Footer className="grid w-full grid-cols-2 gap-2">
                ...
                <Button fullWidth onPress={openMyNotices}>
