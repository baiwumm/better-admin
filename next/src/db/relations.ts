...
import { menus, depts, users, dictTypes, dictItems, logs, refreshTokens, posts, userPosts, notices, noticeReadRecords, noticeRemindLogs, noticeScopes, notifications, roles, userRoles, roleMenus } from "./schema";
...
export const noticeReadRecordsRelations = relations(noticeReadRecords, ({one}) => ({
	notice: one(notices, {
...
export const noticeRemindLogsRelations = relations(noticeRemindLogs, ({one}) => ({
	notice: one(notices, {
